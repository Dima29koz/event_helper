...
Revision ID: 6b1beef32710
Revises: 
Create Date: 2023-08-23 20:34:56.890492
...
def upgrade():
    ...
    op.create_table('person_to_event',
    sa.Column('event_id', sa.Integer(), nullable=True),
    sa.Column('member_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['event.id'], ),
    sa.ForeignKeyConstraint(['member_id'], ['event_member.id'], )
    )
    ...
    op.create_table('product_to_event',
    sa.Column('event_id', sa.Integer(), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('product_to_event')
    op.drop_table('product')
    op.drop_table('person_to_event')
